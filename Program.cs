...
// VatRate(НДС) фиксированный, поэтому const
/*
  VatRate = 0.20
  потому, что НДС = 20%
*/
...
int monthlyExpenses = 3500;
const int MonthsInSemester = 4;
int result = scholarship - monthlyExpenses;
int result1 = scholarship * 4 - monthlyExpenses * 4;
Console.WriteLine($"У студента осталось за месяц {result}");
Console.WriteLine($"Осталось за семестр {result1}");
